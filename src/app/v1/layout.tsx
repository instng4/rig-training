...
export default function V1Layout({
  ...
  return (
    <div className="v1-auth-root font-sans antialiased">
      ...
      */}
      <div className="fixed inset-0 w-screen h-screen flex items-center justify-center bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-100 p-4 py-8 overflow-y-auto z-50 max-sm:items-start max-sm:pt-6">
        <div className="fixed top-0 left-0 w-full h-screen -z-10 hue-rotate-90 pointer-events-none max-sm:hidden">
