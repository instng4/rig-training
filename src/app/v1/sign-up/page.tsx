      ...
      <div className="w-full lg:w-1/2 sm:p-8 md:p-12 lg:p-16 pt-6 pr-6 pb-6 pl-6">
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-slide-right delay-400">
             ...
             <div>
                <label className="sr-only font-geist" htmlFor="lastName">Last name</label>
                <input
                  id="lastName"
                  type="text"
        ...
        <div className="mt-12 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-slate-500 space-y-3 sm:space-y-0 animate-fade-up delay-900">
          <span className="font-geist">Already have an account? <Link href="/v1/sign-in" className="text-violet-600 hover:text-violet-700 font-medium font-geist">Sign in</Link></span>
